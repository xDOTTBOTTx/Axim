                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Subscription</small>
                         </div>
                    ...
                    <form method="post">
                     @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="price" class="form-control" id="price" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="validity">Validity</label>
                            <input type="validity" class="form-control" id="validity" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="datarange">Data Range</label>
                            <input type="datarange" class="form-control" id="datarange" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="points">Points</label>
                            <input type="points" class="form-control" id="points" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="maxusers">Max Users</label>
                            <input type="maxusers" class="form-control" id="maxusers" required>
                        </div>
                        <div class="form-group">
