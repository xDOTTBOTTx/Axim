                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Companies</small>
                         </div>
                    ...
                    <form method="post">
                     @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="pincode" class="form-control" id="pincode" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="phoneno" class="form-control" id="phoneno" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="taxidentificationno"> Tax Identification No</label>
                            <input type="taxidentificationno" class="form-control" id="taxidentificationno" required>
                        </div>
