                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Subscription Data</small>
                         </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="subscription" class="btn btn-link btn-soft-light">
                ...
                <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        ...
                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="subscriptionview/subscriptionedit/" role="button">
                                            <span class="btn-inner">
                                                <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
