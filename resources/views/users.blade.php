                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Users</small>
                         </div>
                    ...
                    <form method="post">
                     @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="role" class="form-control" id="role" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="mobileno">Mobile No</label>
                            <input type="mobileno" class="form-control" id="mobileno" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="addedon">Added On</label>
                            <input type="addedon" class="form-control" id="addedon" required>
                        </div>
                        <div class="form-group">
