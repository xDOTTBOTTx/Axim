                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="/companies" class="btn btn-link btn-soft-light">
                    ...
                    <table class="table mb-0" id="datatable" data-toggle="data-table">
                        <thead>
                            <tr class="bg-white">
                                ...
                                <th scope="col">Tax Identification No</th>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        ...
                                        <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="companiesview/companiesedit/" role="button">
                                            <span class="btn-inner">
