                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Form Elements</small>
                         </div>
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="formsPages">
                                              <li class="nav-item"><a class="nav-link active" href="form-element.html">Element</a></li>
                                              <li class="nav-item"><a class="nav-link " href="form-wizard.html">Wizard</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="addedon">Added On</label>
                            <input type="addedon" class="form-control" id="addedon">
                        </div>
                        <div class="form-group">
