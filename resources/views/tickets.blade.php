                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Ticket</small>
                         </div>
                    ...
                    <form method="post">
                     @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="feedback" class="form-control" id="feedback" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="starter">Starter</label>
                            <input type="starter" class="form-control" id="starter" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="adminnote">Admin Note</label>
                            <input type="adminnote" class="form-control" id="adminnote" required>
                        </div>
