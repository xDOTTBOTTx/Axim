...
<!-- Mirrored from templates.iqonic.design/product/qompac-ui/html/dist/dashboard/analytics-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Oct 2023 23:57:00 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="sidebar-body pt-0 data-scrollbar">
                <div class="sidebar-list">
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="subscription">
                                <i class="icon" data-bs-toggle="tooltip" title="Crypto" data-bs-placement="right">
                                    <svg class="icon-20" width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M10.1167 0.333496H3.88856C1.61893 0.333496 0.333008 1.61942 0.333008 3.88905V10.1113C0.333008 12.3809 1.61893 13.6668 3.88856 13.6668H10.1167C12.3863 13.6668 13.6663 12.3809 13.6663 10.1113V3.88905C13.6663 1.61942 12.3863 0.333496 10.1167 0.333496Z" fill="currentColor"/>
                                        <path d="M3.91244 5.24609C3.61022 5.24609 3.36133 5.49498 3.36133 5.80313V10.3839C3.36133 10.6861 3.61022 10.935 3.91244 10.935C4.22059 10.935 4.46948 10.6861 4.46948 10.3839V5.80313C4.46948 5.49498 4.22059 5.24609 3.91244 5.24609Z" fill="currentColor"/>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="tickets">
                                <i class="icon" data-bs-toggle="tooltip" title="Crypto" data-bs-placement="right">
                                    <svg class="icon-20" width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M10.1167 0.333496H3.88856C1.61893 0.333496 0.333008 1.61942 0.333008 3.88905V10.1113C0.333008 12.3809 1.61893 13.6668 3.88856 13.6668H10.1167C12.3863 13.6668 13.6663 12.3809 13.6663 10.1113V3.88905C13.6663 1.61942 12.3863 0.333496 10.1167 0.333496Z" fill="currentColor"/>
                                        <path d="M3.91244 5.24609C3.61022 5.24609 3.36133 5.49498 3.36133 5.80313V10.3839C3.36133 10.6861 3.61022 10.935 3.91244 10.935C4.22059 10.935 4.46948 10.6861 4.46948 10.3839V5.80313C4.46948 5.49498 4.22059 5.24609 3.91244 5.24609Z" fill="currentColor"/>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="import">
                                <i class="icon" data-bs-toggle="tooltip" title="Crypto" data-bs-placement="right">
                                    <svg class="icon-20" width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M10.1167 0.333496H3.88856C1.61893 0.333496 0.333008 1.61942 0.333008 3.88905V10.1113C0.333008 12.3809 1.61893 13.6668 3.88856 13.6668H10.1167C12.3863 13.6668 13.6663 12.3809 13.6663 10.1113V3.88905C13.6663 1.61942 12.3863 0.333496 10.1167 0.333496Z" fill="currentColor"/>
                                        <path d="M3.91244 5.24609C3.61022 5.24609 3.36133 5.49498 3.36133 5.80313V10.3839C3.36133 10.6861 3.61022 10.935 3.91244 10.935C4.22059 10.935 4.46948 10.6861 4.46948 10.3839V5.80313C4.46948 5.49498 4.22059 5.24609 3.91244 5.24609Z" fill="currentColor"/>
                                ...
                                <span class="item-name">Import Data</span>
                            </a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="export">
                                <i class="icon" data-bs-toggle="tooltip" title="Crypto" data-bs-placement="right">
                                    <svg class="icon-20" width="20" height="20" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M10.1167 0.333496H3.88856C1.61893 0.333496 0.333008 1.61942 0.333008 3.88905V10.1113C0.333008 12.3809 1.61893 13.6668 3.88856 13.6668H10.1167C12.3863 13.6668 13.6663 12.3809 13.6663 10.1113V3.88905C13.6663 1.61942 12.3863 0.333496 10.1167 0.333496Z" fill="currentColor"/>
                                        <path d="M3.91244 5.24609C3.61022 5.24609 3.36133 5.49498 3.36133 5.80313V10.3839C3.36133 10.6861 3.61022 10.935 3.91244 10.935C4.22059 10.935 4.46948 10.6861 4.46948 10.3839V5.80313C4.46948 5.49498 4.22059 5.24609 3.91244 5.24609Z" fill="currentColor"/>
                                ...
                                <span class="item-name">Export Data</span>
                            </a>
                        </li> 
                   ...
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">analytics-dashboard</small>
                         </div>
                               ...
                               <ul class="iq-nav-menu list-unstyled">
                                  <li class="nav-item ">
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                        ...
                                        <li class="nav-item"><a class="nav-link active" href="analytics-dashboard.html">Analytics</a></li>
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="authSkins">
                                              <li class="nav-item"><a class="nav-link " href="auth/sign-in.html">Sign In</a></li>
                                                    ...
                                                    <li class="nav-item"><a class="nav-link " href="auth/two-factor.html">Two Factor</a></li>
                                                    <li class="nav-item"><a class="nav-link " href="auth/account-deactivate.html">Account Deactivate</a></li>                           
                                           </ul>
                                        </li>
                                        <li class="nav-item">
                                     ...
                                     <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                         <li class="nav-item">
                                           ...
                                           <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="ui-element">
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-avatars.html">Avatars</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-alerts.html">Alerts</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-badges.html">Badge</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-breadcrumb.html">Breadcrumb</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-buttons.html">Buttons</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-buttons-group.html">Buttons Group</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-boxshadow.html">Box Shadow</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-color.html">Colors</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-cards.html">Cards</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-carousel.html">Carousel</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-grid.html">Grid</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-images.html">Images</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-list-group.html">List Group</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-modal.html">Modal</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-notifications.html">Notifications</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-pagination.html">Pagination</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-popovers.html">Popovers</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-typography.html">Typography</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-tabs.html">Tabs</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-tooltips.html">Tooltips</a></li>
                                              <li class="nav-item"><a class="nav-link " href="ui-elements/ui-embed-video.html">Video</a></li>
                                           </ul>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="col-lg-3 col-md-6">
             ...
             <div class="col-lg-3 col-md-6">
                <div class="card text-center">
                    <div class="card-body">
                        <h2 class="mb-3">32%</h2>
                        <h5>Total Available Countries </h5>
...
<!-- Mirrored from templates.iqonic.design/product/qompac-ui/html/dist/dashboard/analytics-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Oct 2023 23:57:01 GMT -->
</html>
