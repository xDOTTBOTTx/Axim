                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="feedback" class="form-control" id="feedback">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="starter">Starter</label>
                            <input type="starter" class="form-control" id="starter">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="adminnote">Admin Note</label>
                            <input type="adminnote" class="form-control" id="adminnote">
                        </div>
